...
public class MentorController {
    ...
    public ResponseEntity<MentoringScheduleResponse> getMentoringClassInfoInApply(
            @PathVariable("mentoring_class_id") Long mentoringClassId) {
        MentoringScheduleResponse mentoringScheduleResponse =
                mentorService.getMentorClassScheduleInfo(mentoringClassId);
    ...
    public ResponseEntity<Page<ClassSessionResponse>> getUserClassSession(
        ...
        Page<ClassSessionResponse> classSessionResponses =
                mentorService.getMentorClassSession(userDetails, pageable);
