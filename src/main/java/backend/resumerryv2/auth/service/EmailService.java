...
public class EmailService {
    ...
    public EmailValidation checkValidationCode(String email, Integer validationCode)
            throws CustomException {
        /** 이메일 / validation code / expiretime 확인 */
        Optional<EmailValidation> emailValidation =
                emailValidationRepository.findFirstByEmailOrderByExpireTimeDesc(email);
